...
namespace WebUI.ValidationRules.ContactValidation
{
    public class CreateContactValidator : AbstractValidator<CreateContactDto>
    {
        public CreateContactValidator()
        {
            ...
            RuleFor(x => x.Subject).MaximumLength(50).WithMessage("Konu alanı maksimum 50 karakter olmalıdır.");
            ...
            RuleFor(x => x.Subject).MinimumLength(10).WithMessage("Konu alanı minimum 10 karakter olmalıdır.");
        }
    }
}
